...
def run_absa_analysis():
    ...
    try:
        df = pd.read_csv("C:\\Users\\qazyo\\Desktop\\workspace_DB\\2026DB_finance\\2026DB_work\\google_news_past_30days_0901.csv")
    ...
    # 5. 결과 저장
    final_df.to_csv("C:\\Users\\qazyo\\Desktop\\workspace_DB\\2026DB_finance\\2026DB_work\\5_past_samsung_absa_detail.csv", index=False, encoding='utf-8-sig')
    daily_data.to_csv("C:\\Users\\qazyo\\Desktop\\workspace_DB\\2026DB_finance\\2026DB_work\\5_past_daily_input_for_lstm.csv", index=False, encoding='utf-8-sig')
