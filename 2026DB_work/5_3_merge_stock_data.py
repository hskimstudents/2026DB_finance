...
def merge_absa_with_stock():
    # 1. ABSA 분석 결과 불러오기
    try:
        absa_data = pd.read_csv("C:\\Users\\qazyo\\Desktop\\workspace_DB\\2026DB_finance\\2026DB_work\\5_daily_input_for_lstm.csv")
    ...
    # 5. 최종 저장
    final_dataset.to_csv("C:\\Users\\qazyo\\Desktop\\workspace_DB\\2026DB_finance\\2026DB_work\\5_final_lstm_training_data.csv", index=False, encoding='utf-8-sig')
